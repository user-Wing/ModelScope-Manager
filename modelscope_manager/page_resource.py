...
class ResourcePageMixin:
    ...
    def _build_resource_page(self) -> QWidget:
        ...
        self.resource_import_url_button = QPushButton("从链接导入文件")
        self.resource_import_url_button.setEnabled(False)
        self.resource_import_url_button.clicked.connect(self.show_url_import_dialog)
        resource_heading.addWidget(self.resource_import_url_button)
        ...
        self.remote_detail_tree.setHeaderLabels(["名称", "类型", "大小", "最后修改", "存储方式", "SHA-256", "Blob ID"])
        ...
        detail_header.setContextMenuPolicy(Qt.ContextMenuPolicy.CustomContextMenu)
        detail_header.customContextMenuRequested.connect(self._show_remote_column_selector)
        self.remote_detail_tree.setColumnWidth(0, 280)
        self.remote_detail_tree.setColumnWidth(1, 90)
        self.remote_detail_tree.setColumnWidth(2, 110)
        self.remote_detail_tree.setColumnWidth(3, 180)
        self.remote_detail_tree.setColumnWidth(4, 100)
        self.remote_detail_tree.setColumnWidth(5, 260)
        self.remote_detail_tree.setColumnWidth(6, 220)
